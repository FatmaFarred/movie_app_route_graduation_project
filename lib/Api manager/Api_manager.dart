...
class ApiManager {
 ...
 Future <Response> postData ({required String endPoint,Map<String, dynamic> ?queryParameters , Options? options, Object? data,
 ...
 Future <Response> patchData ({required String endPoint,Map<String, dynamic> ?queryParameters , Options? options, Object? data,
   Map<String, dynamic>? headers
 }){
   return dio.patch(ApiConstant.baseUrl+endPoint,
     queryParameters: queryParameters,
     data:data ,
