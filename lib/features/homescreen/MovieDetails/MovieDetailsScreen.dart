        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    iconWithTextContainerWidget(
                        ...
                        title: "${state?.response?.data?.movie?.likeCount ?? ""}"),
                    iconWithTextContainerWidget(
              ...
              ScreenShotWidget(
                imagePath: state?.response?.data?.movie?.mediumScreenshotImage1 ?? "",
                height: 166.h,
              ),
              ScreenShotWidget(
                imagePath: state?.response?.data?.movie?.mediumScreenshotImage2 ?? "",
                height: 166.h,
              ),
              ScreenShotWidget(
                imagePath: state?.response?.data?.movie?.mediumScreenshotImage3 ?? "",
                height: 166.h,
              ),
              SizedBox(height: 9.h),
              TextWidget(
                  ...
                  style: getBoldStyle(
                      ...
                      fontFamily: FontConstants.robotoFont)),
              SizedBox(height: 9.h),
              MovieSuggetionScreen(movieId:widget.movieId ,),
              Padding(
                padding: EdgeInsets.only(top: 16.h, bottom: 16.h),
                child: TextWidget(
