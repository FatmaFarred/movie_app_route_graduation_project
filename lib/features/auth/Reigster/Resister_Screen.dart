    ...
    return BlocListener<RegisterViewModel, RegisterState>(
      ...
      listener: (context, state) {
        if (state is LoadingRegisterState) {
          Customizied_Alert_Dialogue.showLoading(
                  ...
                  CarouselSlider.builder(
                      ...
                      options: CarouselOptions(
                          ...
                          onPageChanged: (index, changereson) {
                            ...
                            print(
                                "the avatar is $registerViewModel.selectedAvater");
                  ...
                  CustomTextField(
                    validator: (text) {
                      ...
                      final bool phoneValid =
                          RegExp(r'^\+[2]{1}[0-9]{3,14}$').hasMatch(text);

                      /// olny egypt code if not will replace [2] to [1_9]
